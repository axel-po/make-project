...
CREATE TABLE "UsersWhoWantJoinProject" (
    ...
    CONSTRAINT "UsersWhoWantJoinProject_pkey" PRIMARY KEY ("projectId","userId")
);
...
-- AddForeignKey
ALTER TABLE "UsersWhoWantJoinProject" ADD CONSTRAINT "UsersWhoWantJoinProject_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UsersWhoWantJoinProject" ADD CONSTRAINT "UsersWhoWantJoinProject_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
